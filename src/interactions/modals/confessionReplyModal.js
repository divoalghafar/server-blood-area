...
module.exports = {
  customId: CONFESSION_MODAL_IDS.reply,
  ...
  async execute(interaction) {
    ...
    const validationError = validateReply(message, targetUsername);
    if (validationError) {
      await interaction.reply({
    ...
    await interaction.reply({
      content: '✅ Confession reply berhasil dikirim secara anonim.',
      ephemeral: true
    });
  }
};

function validateReply(message, targetUsername) {
